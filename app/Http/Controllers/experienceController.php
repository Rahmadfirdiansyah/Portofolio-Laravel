...
class experienceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate(
            ...
            return redirect()->route('experience.index')->with('success', 'berhasil menambahakan data experience');
    ...
    public function update(Request $request, $id)
    {
        $request->validate(
            ...
            return redirect()->route('experience.index')->with('success', 'berhasil mengupdate data experience');
